...
-- This is post 1/n: only made first deep learning models and will try many improvements, but already lots of learnings, want to get down sooner vs later
...
-- Learn evaluation techniques, ways to identify potential improvements to model